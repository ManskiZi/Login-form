...
int main()
{
    ...
    else if(choice == 2) // if user chooses to login
    {
        ...
        if(!status)// if isLoggenIn() returns false
        {
            system("clear");
            cout << endl;
        ...
        else // if isLoggedIn() returns true, the dashoard is displayed
        {
            ...
            cout << endl;
            cout << "DASHBOARD" << endl;
            cout << "No new messages." << endl; // example of what could appear on the user's dashoard
            cout << endl;
